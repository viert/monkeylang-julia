...
@enum TokenType ILLEGAL = 1 EOF IDENT INT ASSIGN PLUS MINUS BANG ASTERISK SLASH LT GT COMMA SEMICOLON LPAREN RPAREN LBRACE RBRACE FUNCTION LET TRUE FALSE RETURN IF ELSE EQUAL NOTEQUAL
